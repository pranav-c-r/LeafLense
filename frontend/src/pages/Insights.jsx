...
const Insights = () => {
  ...
  const getInsightColor = (type) => {
    switch (type) {
      ...
      case 'info': return 'from-blue-500/20 to-blue-600/10 border-blue-500/30'
    ...
    <div className="p-6 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-slate-400">Smart recommendations and analysis</p>
          </div>
        </div>
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-3">
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                    ...
                    insight.color === 'blue' ? 'bg-blue-500/20' : 'bg-slate-500/20'
                  }`}>
                    <insight.icon className={`h-5 w-5 ${
                      insight.color === 'yellow' ? 'text-yellow-400' :
                      insight.color === 'green' ? 'text-green-400' :
                      insight.color === 'blue' ? 'text-blue-400' : 'text-slate-400'
                    }`} />
                  </div>
                  <div>
                ...
                <span className="text-sm font-medium text-slate-300">{insight.confidence}%</span>
              </div>
      ...
      <div className="bg-slate-800/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
        ...
        <div className="space-y-4">
          {recommendations.map((rec, index) => (
            <div key={index} className="flex items-center justify-between p-4 bg-slate-700/30 rounded-lg hover:bg-slate-600/30 transition-colors">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-400">{rec.category}</div>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-slate-800/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
          ...
          <p className="text-slate-400 text-sm">Expected increase vs last season</p>
        </div>
        ...
        <div className="bg-slate-800/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
          ...
          <p className="text-slate-400 text-sm">Prediction confidence level</p>
        </div>
        ...
        <div className="bg-slate-800/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
          ...
          <p className="text-slate-400 text-sm">Real-time recommendations</p>
        </div>
      </div>
    </div>
  )
